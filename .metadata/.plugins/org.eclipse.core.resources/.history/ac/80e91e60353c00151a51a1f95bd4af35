...
access_token = os.getenv("16384709.6ac06b4.49b97800d7fd4ac799a2c889f50f2587")

# ask for hashtag name
hashtag = raw_input("What hashtag would you like to download photos of? ")

# url to query for pictures
nextUrl = "https://api.instagram.com/v1/tags/"+hashtag+"/media/recent?access_token="+"16384709.6ac06b4.49b97800d7fd4ac799a2c889f50f2587"
print nextUrl
